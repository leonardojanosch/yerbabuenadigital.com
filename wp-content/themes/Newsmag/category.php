...
//Check category template to remove title, breadcrumbs, description in main content area
$td_category_style = td_api_category_template::_helper_get_active_id();
                        ...
                        ?>
                            <div class="td-pb-span8 td-main-content">
                                <div class="td-ss-main-content">
                                    <?php
                                    //remove title, breadcrumbs, description in main content area for the other templates
                                        if ($td_category_style == "td_category_template_1") {
                                            locate_template('parts/page-category-header.php', true);
                                        }
                                    ?>
